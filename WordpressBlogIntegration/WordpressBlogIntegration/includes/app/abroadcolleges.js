jQuery(document).ready(function ($) {
    ...
    var app = {
        ...
        loadEvents : function() {
            ...
            $( '#colleges-abroad' ).on( 'click', '.blog-post h3', this.loadSinglePost )
            $( '#colleges-abroad' ).on( 'click', '.blog-post .thumbnail', this.loadSinglePost )
        ...
        loadPosts : function() {
            ...
            var url = RESTURL +'wp/v2/posts?_embed&&categories=35403&per_page=40'
            ...
            $.get( url )
                .done( function( response ) {
                    ...
                    var template = $( '#blog-post-template3' ).html()
                    var output = $( '#colleges-abroad' )
