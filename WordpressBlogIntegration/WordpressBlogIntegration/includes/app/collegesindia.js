jQuery(document).ready(function ($) {
    ...
    var app = {
        ...
        loadEvents : function() {
            ...
            $( '#colleges-india' ).on( 'click', '.blog-post h3', this.loadSinglePost )
            $( '#colleges-india' ).on( 'click', '.blog-post .thumbnail', this.loadSinglePost )
        ...
        loadPosts : function() {
            ...
            var url = RESTURL +'wp/v2/posts?_embed&&categories=28033&per_page=30'
            ...
            $.get( url )
                .done( function( response ) {
                    ...
                    var template = $( '#blog-post-template2' ).html()
                    var output = $( '#colleges-india' )
        ...
        loadCategories : function() {
            ...
            $.get( url )
                .done( function( response ) {
                    ...
                    var template = $( '#blog-categories-template2' ).html()
