jQuery(document).ready(function ($) {
    ...
    var app = {
        ...
        loadEvents : function() {
            ...
            $( '#new-age' ).on( 'click', '.blog-post h3', this.loadSinglePost )
            $( '#new-age' ).on( 'click', '.blog-post .thumbnail', this.loadSinglePost )
        ...
        loadPosts : function() {
            ...
            var url = RESTURL +'wp/v2/posts?_embed&&categories=4609,46324&per_page=100'
            ...
            $.get( url )
                .done( function( response ) {
                    ...
                    var template = $( '#blog-post-template1' ).html()
                    var output = $( '#new-age' )
